    ...
    column(
      ...
      card(
        ...
        card_body(
          ...
          div(class = "table-wrap", DT::DTOutput("other_columns_table"))
        )
      )
    )
  ),
      ...
      fluidRow(
        column(
          ...
          div(
            ...
            div(class = "table-wrap", DT::DTOutput("llm_table"))
          )
        ),
        column(
          6,
          div(
            ...
            div(class = "table-wrap", DT::DTOutput("manual_table"))
          )
        )
      ),
...
server <- function(input, output, session) {
  ...
  output$other_columns_table <- DT::renderDT({
    ...
    if (input$current_row <= vals$total_rows) {
      ...
      show_datatable(selected_data_t, 3)
    }
  })
  ...
  output$manual_table <- DT::renderDT({
    ...
    if (input$current_row <= vals$total_rows) {
      ...
      show_datatable(manual_row_data_t, 3,
